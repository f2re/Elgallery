...
/**
 * Main Elementor Elgallery Class
 *
 * The init class that runs the Elementor Elgallery plugin.
 ...
 */
final class Elementor_Elgallery {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-elgallery' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_ELGALLERY ) );
...
// Instantiate Elementor_Elgallery.
new Elementor_Elgallery();
